...
DEFINE_bool(enable_chuncked_tablet_writes, true,
...
TAG_FLAG(enable_chuncked_tablet_writes, experimental);
TAG_FLAG(enable_chuncked_tablet_writes, runtime);
...
Status CatalogManager::ProcessDeletedTablets(const vector<scoped_refptr<TabletInfo>>& tablets,
  ...
  const auto write_mode = FLAGS_enable_chuncked_tablet_writes ? SysCatalogTable::WriteMode::CHUNKED
                                                              : SysCatalogTable::WriteMode::ATOMIC;
